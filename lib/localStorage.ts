    ...
    const defaultProducts: Product[] = [
      {
        ...
        brand: "DOPE",
        tags: ["oversized", "unisex", "cotton", "tiger", "premium"],
      },
      {
        id: "2",
        ...
        discount: 18,
        image: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/image-RMkXrTxnA1vpz17GZLeE524Ifu4M1Q.png",
        images: ["https://hebbkx1anhila5yf.public.blob.vercel-storage.com/image-RMkXrTxnA1vpz17GZLeE524Ifu4M1Q.png"],
        videoUrl: "/placeholder.mp4",
        rating: 4.8,
        reviews: 89,
        category: "t-shirts",
        description:
          "Oversized unisex t-shirt with vibrant hummingbird design. Premium quality fabric with a relaxed fit.",
        sizes: ["S", "M", "L", "XL", "XXL"],
        ...
        createdAt: new Date().toISOString(),
        brand: "DOPE",
        tags: ["oversized", "unisex", "hummingbird", "vibrant"],
      },
      {
        id: "3",
        ...
        originalPrice: 5495,
        discount: 18,
        image: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/image-DG9GoDGjwfMdAN8k9QLKtEc56pffNn.png",
        videoUrl: "/placeholder.mp4",
        rating: 4.9,
        reviews: 156,
        category: "t-shirts",
        ...
        createdAt: new Date().toISOString(),
        brand: "DOPE",
        tags: ["oversized", "mantis", "black", "intricate"],
      },
      {
        id: "4",
        ...
        category: "t-shirts",
        description:
          "Navy blue oversized t-shirt featuring a detailed starling bird design. Perfect for casual everyday wear.",
        sizes: ["S", "M", "L", "XL", "XXL"],
        ...
        createdAt: new Date().toISOString(),
        brand: "DOPE",
        tags: ["navy", "starling", "casual", "everyday"],
      },
      {
        id: "5",
