    ...
    <section className="py-10 md:py-16 bg-gray-900 text-white">
      <div className="w-full max-w-[1440px] mx-auto px-2 sm:px-6 lg:px-8">
        <div className="max-w-xl mx-auto text-center">
          <h2 className="text-2xl md:text-3xl font-bold mb-2 md:mb-4">Hi there, sign up and connect to DOPE</h2>
          <p className="text-gray-300 mb-6 md:mb-8 text-xs md:text-base">
